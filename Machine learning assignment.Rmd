...
#### 6. Prediction on the final test set
...
#### 7. File generation for answer submission
Using the provided function to export the results of the predictions

```{r ExportingResuts, echo = TRUE, warning = FALSE, message=FALSE, cache=FALSE}
answers = predRF80Test
